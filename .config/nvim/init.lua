...
vim.api.nvim_create_autocmd("CursorHold", {
	...
	group = vim.api.nvim_create_augroup("kdb-open-diagnostics", { clear = true }),
	callback = function()
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>o", builtin.git_files, { desc = "Find Git files" })
			vim.keymap.set("n", "<C-o>", builtin.find_files, { desc = "Find all files" })
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			-- Add/delete/replace surroudings (brackets, quotes, etc.)
			--
